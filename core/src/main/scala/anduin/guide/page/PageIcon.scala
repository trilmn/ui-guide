  ...
  def render(ctl: Main.Ctl): VdomElement = {
    <.div(
      ...
      renderIcons (
        ...
        <.div(flex, IconAcl(name = IconAcl.NameCheckSmall)(), " ", "CheckSmall"),
        ...
        <.div(flex, IconAcl(name = IconAcl.NameSignatureRequest)(), " ", "SignatureRequest"),
        <.div(flex, IconAcl(name = IconAcl.NameSignatureEdit)(), " ", "SignatureEdit"),
        <.div(flex, IconAcl(name = IconAcl.NameClipboard)(), " ", "Clipboard"),
        <.div(flex, IconAcl(name = IconAcl.NameClipboardCopied)(), " ", "ClipboardCopied"),
        ...
        <.div(flex, IconAcl(name = IconAcl.NameEditInline)(), " ", "EditInline"),
        <.div(flex, IconAcl(name = IconAcl.NameEditField)(), " ", "EditField"),
        ...
        <.div(flex, IconAcl(name = IconAcl.NameCompare)(), " ", "Compare"),
        <.div(flex, IconAcl(name = IconAcl.NameMove)(), " ", "Move"),
      ...
      renderIcons(
        <.div(flex, IconAcl(name = IconAcl.NameBrandAnduin)(), " ", "BrandAnduin"),
        <.div(flex, IconAcl(name = IconAcl.NameBrandMicrosoft)(), " ", "BrandMicrosoft"),
        <.div(flex, IconAcl(name = IconAcl.NameBrandGoogle)(), " ", "BrandGoogle")
      ...
      renderIcons(
        ...
        <.div(flex, IconAcl(name = IconAcl.NameChevronHorizontalUp)(), " ", "ChevronHorizontalDown"),
        <.div(flex, IconAcl(name = IconAcl.NameChevronHorizontalDown)(), " ", "ChevronHorizontalDown"),
      ...
      renderIcons(
        ...
        <.div(flex, IconAcl(name = IconAcl.NameEnvelopeSend)(), " ", "EnvelopeSend"),
        <.div(flex, IconAcl(name = IconAcl.NameAttachment)(), " ", "Attachment"),
      ...
      renderIcons(
        ...
        <.div(flex, IconAcl(name = IconAcl.NameFilePreview)(), " ", "FilePreview"),
        ...
        <.div(flex, IconAcl(name = IconAcl.NameFolderSend)(), " ", "FolderSend"),
        ...
        <.div(flex, IconAcl(name = IconAcl.NameFolderSendLine)(), " ", "FolderSendLine")
      ),
      Markdown(
        """
          |## Interface
      ...
      renderIcons(
        ...
        <.div(flex, IconAcl(name = IconAcl.NameSnapshot)(), " ", "Snapshot"),
        <.div(flex, IconAcl(name = IconAcl.NameDashboard)(), " ", "Dashboard"),
        ...
        <.div(flex, IconAcl(name = IconAcl.NameKey)(), " ", "Key"),
        ...
        <.div(flex, IconAcl(name = IconAcl.NameDataRoom)(), " ", "DataRoom"),
        <.div(flex, IconAcl(name = IconAcl.NameKnowledge)(), " ", "Knowledge"),
        <.div(flex, IconAcl(name = IconAcl.NameInfo)(), " ", "Info"),
        <.div(flex, IconAcl(name = IconAcl.NameInfoCircleLine)(), " ", "InfoCircleLine"),
        <.div(flex, IconAcl(name = IconAcl.NameWarning)(), " ", "Warning"),
        <.div(flex, IconAcl(name = IconAcl.NameError)(), " ", "Error"),
        <.div(flex, IconAcl(name = IconAcl.NameComputer)(), " ", "Computer"),
        <.div(flex, IconAcl(name = IconAcl.NameMobile)(), " ", "Mobile"),
        <.div(flex, IconAcl(name = IconAcl.NameMobileAuthenticate)(), " ", "MobileAuthenticate"),
        ...
        <.div(flex, IconAcl(name = IconAcl.NameCircleLine)(), " ", "CircleLine"),
      ...
      renderIcons(
        <.div(flex, IconAcl(name = IconAcl.NameTable)(), " ", "Table"),
      ...
      renderIcons(
        ...
        <.div(flex, IconAcl(name = IconAcl.NameUserLink)(), " ", "UserLink"),
        <.div(flex, IconAcl(name = IconAcl.NameUserInfo)(), " ", "UserInfo")
      )
    )
  }
