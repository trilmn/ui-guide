      ...
      ExampleRich(
        Source.annotate(
          /*>*/ <.div(
            ...
            <.code(Style.backgroundColor.gray2.padding.ver4.padding.hor8, /*<*/ Style.fontFamily.mono /*>*/, "746123")
          ) /*<*/
        )
      )(),
      Markdown(
        s"""
           ...
           |# Line Height
           |
           |We use a set of [fixed line height](${ctl
             .urlFor(Main.FixedLineHeight())
             .value}), with the default value being 20 pixels. The default value should work for most use cases, including paragraph (since the default font size is 14 pixels) or short string of text on UI (e.g: label, information, value).
           |
